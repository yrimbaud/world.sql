...
(1917, 'UrumtÅ¡i [ÃrÃ¼mqi]', 'CHN', 'Xinxiang', 1310100),
...
(2974, 'Paris', 'FRA', 'Ãle-de-France', 2125246),
...
(3347, 'ÃstÃ­ nad Labem', 'CZE', 'SevernÃ­ Cechy', 95491),
...
(3514, 'Ãrgenc', 'UZB', 'Khorazm', 138900),
...
-- ############################################################################
-- #                                                                          #
-- #  MISES A JOUR DE LA BASE DE DONNEES WORLD (2024-2025)                    #
-- #  Donnees mises a jour le 2 decembre 2025                                 #
-- #                                                                          #
-- #  - Chefs d'Etat actualises                                               #
-- #  - Populations des pays et villes mises a jour                           #
-- #  - Nouveaux pays ajoutes: Soudan du Sud, Montenegro, Serbie, Kosovo      #
-- #  - Yougoslavie supprimee                                                 #
-- #  - East Timor renomme en Timor-Leste                                     #
-- #  - Corrections diverses (noms de pays, formes de gouvernement)           #
-- #                                                                          #
-- ############################################################################

-- ============================================
-- MISES A JOUR DES CHEFS D'ETAT (2024-2025)
-- ============================================

UPDATE `country` SET `HeadOfState` = 'Willem-Alexander' WHERE `Code` = 'ABW';
UPDATE `country` SET `HeadOfState` = 'Hibatullah Akhundzada' WHERE `Code` = 'AFG';
UPDATE `country` SET `HeadOfState` = 'Joao Lourenco' WHERE `Code` = 'AGO';
UPDATE `country` SET `HeadOfState` = 'Mohamed bin Zayed Al Nahyan' WHERE `Code` = 'ARE';
UPDATE `country` SET `HeadOfState` = 'Javier Milei' WHERE `Code` = 'ARG';
UPDATE `country` SET `HeadOfState` = 'Vahagn Khachaturyan' WHERE `Code` = 'ARM';
UPDATE `country` SET `HeadOfState` = 'Donald Trump' WHERE `Code` = 'ASM';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'AUS';
UPDATE `country` SET `HeadOfState` = 'Alexander Van der Bellen' WHERE `Code` = 'AUT';
UPDATE `country` SET `HeadOfState` = 'Ilham Aliyev' WHERE `Code` = 'AZE';
UPDATE `country` SET `HeadOfState` = 'Evariste Ndayishimiye' WHERE `Code` = 'BDI';
UPDATE `country` SET `HeadOfState` = 'Philippe' WHERE `Code` = 'BEL';
UPDATE `country` SET `HeadOfState` = 'Patrice Talon' WHERE `Code` = 'BEN';
UPDATE `country` SET `HeadOfState` = 'Ibrahim Traore' WHERE `Code` = 'BFA';
UPDATE `country` SET `HeadOfState` = 'Mohammed Shahabuddin' WHERE `Code` = 'BGD';
UPDATE `country` SET `HeadOfState` = 'Rumen Radev' WHERE `Code` = 'BGR';
UPDATE `country` SET `HeadOfState` = 'Hamad bin Isa Al Khalifa' WHERE `Code` = 'BHR';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'BHS';
UPDATE `country` SET `HeadOfState` = 'Denis Becirovic' WHERE `Code` = 'BIH';
UPDATE `country` SET `HeadOfState` = 'Alexander Lukashenko' WHERE `Code` = 'BLR';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'BLZ';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'BMU';
UPDATE `country` SET `HeadOfState` = 'Luis Arce' WHERE `Code` = 'BOL';
UPDATE `country` SET `HeadOfState` = 'Luiz Inacio Lula da Silva' WHERE `Code` = 'BRA';
UPDATE `country` SET `HeadOfState` = 'Sandra Mason' WHERE `Code` = 'BRB';
UPDATE `country` SET `HeadOfState` = 'Hassanal Bolkiah' WHERE `Code` = 'BRN';
UPDATE `country` SET `HeadOfState` = 'Jigme Khesar Namgyel Wangchuck' WHERE `Code` = 'BTN';
UPDATE `country` SET `HeadOfState` = 'Duma Boko' WHERE `Code` = 'BWA';
UPDATE `country` SET `HeadOfState` = 'Faustin-Archange Touadera' WHERE `Code` = 'CAF';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'CAN';
UPDATE `country` SET `HeadOfState` = 'Karin Keller-Sutter' WHERE `Code` = 'CHE';
UPDATE `country` SET `HeadOfState` = 'Gabriel Boric' WHERE `Code` = 'CHL';
UPDATE `country` SET `HeadOfState` = 'Xi Jinping' WHERE `Code` = 'CHN';
UPDATE `country` SET `HeadOfState` = 'Alassane Ouattara' WHERE `Code` = 'CIV';
UPDATE `country` SET `HeadOfState` = 'Paul Biya' WHERE `Code` = 'CMR';
UPDATE `country` SET `HeadOfState` = 'Felix Tshisekedi' WHERE `Code` = 'COD';
UPDATE `country` SET `HeadOfState` = 'Denis Sassou Nguesso' WHERE `Code` = 'COG';
UPDATE `country` SET `HeadOfState` = 'Gustavo Petro' WHERE `Code` = 'COL';
UPDATE `country` SET `HeadOfState` = 'Azali Assoumani' WHERE `Code` = 'COM';
UPDATE `country` SET `HeadOfState` = 'Jose Maria Neves' WHERE `Code` = 'CPV';
UPDATE `country` SET `HeadOfState` = 'Rodrigo Chaves' WHERE `Code` = 'CRI';
UPDATE `country` SET `HeadOfState` = 'Miguel Diaz-Canel' WHERE `Code` = 'CUB';
UPDATE `country` SET `HeadOfState` = 'Nikos Christodoulides' WHERE `Code` = 'CYP';
UPDATE `country` SET `HeadOfState` = 'Petr Pavel' WHERE `Code` = 'CZE';
UPDATE `country` SET `HeadOfState` = 'Frank-Walter Steinmeier' WHERE `Code` = 'DEU';
UPDATE `country` SET `HeadOfState` = 'Ismail Omar Guelleh' WHERE `Code` = 'DJI';
UPDATE `country` SET `HeadOfState` = 'Sylvanie Burton' WHERE `Code` = 'DMA';
UPDATE `country` SET `HeadOfState` = 'Frederik X' WHERE `Code` = 'DNK';
UPDATE `country` SET `HeadOfState` = 'Luis Abinader' WHERE `Code` = 'DOM';
UPDATE `country` SET `HeadOfState` = 'Abdelmadjid Tebboune' WHERE `Code` = 'DZA';
UPDATE `country` SET `HeadOfState` = 'Daniel Noboa' WHERE `Code` = 'ECU';
UPDATE `country` SET `HeadOfState` = 'Abdel Fattah el-Sisi' WHERE `Code` = 'EGY';
UPDATE `country` SET `HeadOfState` = 'Isaias Afwerki' WHERE `Code` = 'ERI';
UPDATE `country` SET `HeadOfState` = 'Felipe VI' WHERE `Code` = 'ESP';
UPDATE `country` SET `HeadOfState` = 'Alar Karis' WHERE `Code` = 'EST';
UPDATE `country` SET `HeadOfState` = 'Taye Atske Selassie' WHERE `Code` = 'ETH';
UPDATE `country` SET `HeadOfState` = 'Alexander Stubb' WHERE `Code` = 'FIN';
UPDATE `country` SET `HeadOfState` = 'Wiliame Katonivere' WHERE `Code` = 'FJI';
UPDATE `country` SET `HeadOfState` = 'Emmanuel Macron' WHERE `Code` = 'FRA';
UPDATE `country` SET `HeadOfState` = 'Brice Oligui Nguema' WHERE `Code` = 'GAB';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'GBR';
UPDATE `country` SET `HeadOfState` = 'Mikheil Kavelashvili' WHERE `Code` = 'GEO';
UPDATE `country` SET `HeadOfState` = 'John Dramani Mahama' WHERE `Code` = 'GHA';
UPDATE `country` SET `HeadOfState` = 'Mamadi Doumbouya' WHERE `Code` = 'GIN';
UPDATE `country` SET `HeadOfState` = 'Adama Barrow' WHERE `Code` = 'GMB';
UPDATE `country` SET `HeadOfState` = 'Umaro Sissoco Embalo' WHERE `Code` = 'GNB';
UPDATE `country` SET `HeadOfState` = 'Teodoro Obiang Nguema Mbasogo' WHERE `Code` = 'GNQ';
UPDATE `country` SET `HeadOfState` = 'Katerina Sakellaropoulou' WHERE `Code` = 'GRC';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'GRD';
UPDATE `country` SET `HeadOfState` = 'Frederik X' WHERE `Code` = 'GRL';
UPDATE `country` SET `HeadOfState` = 'Bernardo Arevalo' WHERE `Code` = 'GTM';
UPDATE `country` SET `HeadOfState` = 'Emmanuel Macron' WHERE `Code` = 'GUF';
UPDATE `country` SET `HeadOfState` = 'Donald Trump' WHERE `Code` = 'GUM';
UPDATE `country` SET `HeadOfState` = 'Irfaan Ali' WHERE `Code` = 'GUY';
UPDATE `country` SET `HeadOfState` = 'Xi Jinping' WHERE `Code` = 'HKG';
UPDATE `country` SET `HeadOfState` = 'Xiomara Castro' WHERE `Code` = 'HND';
UPDATE `country` SET `HeadOfState` = 'Zoran Milanovic' WHERE `Code` = 'HRV';
UPDATE `country` SET `HeadOfState` = 'Laurent Saint-Cyr' WHERE `Code` = 'HTI';
UPDATE `country` SET `HeadOfState` = 'Tamas Sulyok' WHERE `Code` = 'HUN';
UPDATE `country` SET `HeadOfState` = 'Prabowo Subianto' WHERE `Code` = 'IDN';
UPDATE `country` SET `HeadOfState` = 'Droupadi Murmu' WHERE `Code` = 'IND';
UPDATE `country` SET `HeadOfState` = 'Catherine Connolly' WHERE `Code` = 'IRL';
UPDATE `country` SET `HeadOfState` = 'Ali Khamenei' WHERE `Code` = 'IRN';
UPDATE `country` SET `HeadOfState` = 'Abdul Latif Rashid' WHERE `Code` = 'IRQ';
UPDATE `country` SET `HeadOfState` = 'Halla Tomasdottir' WHERE `Code` = 'ISL';
UPDATE `country` SET `HeadOfState` = 'Isaac Herzog' WHERE `Code` = 'ISR';
UPDATE `country` SET `HeadOfState` = 'Sergio Mattarella' WHERE `Code` = 'ITA';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'JAM';
UPDATE `country` SET `HeadOfState` = 'Abdullah II' WHERE `Code` = 'JOR';
UPDATE `country` SET `HeadOfState` = 'Naruhito' WHERE `Code` = 'JPN';
UPDATE `country` SET `HeadOfState` = 'Kassym-Jomart Tokayev' WHERE `Code` = 'KAZ';
UPDATE `country` SET `HeadOfState` = 'William Ruto' WHERE `Code` = 'KEN';
UPDATE `country` SET `HeadOfState` = 'Sadyr Japarov' WHERE `Code` = 'KGZ';
UPDATE `country` SET `HeadOfState` = 'Norodom Sihamoni' WHERE `Code` = 'KHM';
UPDATE `country` SET `HeadOfState` = 'Taneti Maamau' WHERE `Code` = 'KIR';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'KNA';
UPDATE `country` SET `HeadOfState` = 'Lee Jae-myung' WHERE `Code` = 'KOR';
UPDATE `country` SET `HeadOfState` = 'Mishal Al-Ahmad Al-Jaber Al-Sabah' WHERE `Code` = 'KWT';
UPDATE `country` SET `HeadOfState` = 'Thongloun Sisoulith' WHERE `Code` = 'LAO';
UPDATE `country` SET `HeadOfState` = 'Joseph Aoun' WHERE `Code` = 'LBN';
UPDATE `country` SET `HeadOfState` = 'Joseph Boakai' WHERE `Code` = 'LBR';
UPDATE `country` SET `HeadOfState` = 'Mohamed al-Menfi' WHERE `Code` = 'LBY';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'LCA';
UPDATE `country` SET `HeadOfState` = 'Hans-Adam II' WHERE `Code` = 'LIE';
UPDATE `country` SET `HeadOfState` = 'Anura Kumara Dissanayake' WHERE `Code` = 'LKA';
UPDATE `country` SET `HeadOfState` = 'Letsie III' WHERE `Code` = 'LSO';
UPDATE `country` SET `HeadOfState` = 'Gitanas Nauseda' WHERE `Code` = 'LTU';
UPDATE `country` SET `HeadOfState` = 'Henri' WHERE `Code` = 'LUX';
UPDATE `country` SET `HeadOfState` = 'Edgars Rinkevics' WHERE `Code` = 'LVA';
UPDATE `country` SET `HeadOfState` = 'Xi Jinping' WHERE `Code` = 'MAC';
UPDATE `country` SET `HeadOfState` = 'Mohammed VI' WHERE `Code` = 'MAR';
UPDATE `country` SET `HeadOfState` = 'Albert II' WHERE `Code` = 'MCO';
UPDATE `country` SET `HeadOfState` = 'Maia Sandu' WHERE `Code` = 'MDA';
UPDATE `country` SET `HeadOfState` = 'Andry Rajoelina' WHERE `Code` = 'MDG';
UPDATE `country` SET `HeadOfState` = 'Mohamed Muizzu' WHERE `Code` = 'MDV';
UPDATE `country` SET `HeadOfState` = 'Claudia Sheinbaum' WHERE `Code` = 'MEX';
UPDATE `country` SET `HeadOfState` = 'Hilda Heine' WHERE `Code` = 'MHL';
UPDATE `country` SET `HeadOfState` = 'Gordana Siljanovska-Davkova' WHERE `Code` = 'MKD';
UPDATE `country` SET `HeadOfState` = 'Assimi Goita' WHERE `Code` = 'MLI';
UPDATE `country` SET `HeadOfState` = 'Myriam Spiteri Debono' WHERE `Code` = 'MLT';
UPDATE `country` SET `HeadOfState` = 'Min Aung Hlaing' WHERE `Code` = 'MMR';
UPDATE `country` SET `HeadOfState` = 'Ukhnaagiin Khurelsukh' WHERE `Code` = 'MNG';
UPDATE `country` SET `HeadOfState` = 'Donald Trump' WHERE `Code` = 'MNP';
UPDATE `country` SET `HeadOfState` = 'Daniel Chapo' WHERE `Code` = 'MOZ';
UPDATE `country` SET `HeadOfState` = 'Mohamed Ould Ghazouani' WHERE `Code` = 'MRT';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'MSR';
UPDATE `country` SET `HeadOfState` = 'Emmanuel Macron' WHERE `Code` = 'MTQ';
UPDATE `country` SET `HeadOfState` = 'Prithvirajsing Roopun' WHERE `Code` = 'MUS';
UPDATE `country` SET `HeadOfState` = 'Lazarus Chakwera' WHERE `Code` = 'MWI';
UPDATE `country` SET `HeadOfState` = 'Ibrahim Iskandar' WHERE `Code` = 'MYS';
UPDATE `country` SET `HeadOfState` = 'Emmanuel Macron' WHERE `Code` = 'MYT';
UPDATE `country` SET `HeadOfState` = 'Netumbo Nandi-Ndaitwah' WHERE `Code` = 'NAM';
UPDATE `country` SET `HeadOfState` = 'Emmanuel Macron' WHERE `Code` = 'NCL';
UPDATE `country` SET `HeadOfState` = 'Abdourahamane Tchiani' WHERE `Code` = 'NER';
UPDATE `country` SET `HeadOfState` = 'Bola Tinubu' WHERE `Code` = 'NGA';
UPDATE `country` SET `HeadOfState` = 'Daniel Ortega' WHERE `Code` = 'NIC';
UPDATE `country` SET `HeadOfState` = 'Willem-Alexander' WHERE `Code` = 'NLD';
UPDATE `country` SET `HeadOfState` = 'Harald V' WHERE `Code` = 'NOR';
UPDATE `country` SET `HeadOfState` = 'Ram Chandra Poudel' WHERE `Code` = 'NPL';
UPDATE `country` SET `HeadOfState` = 'David Adeang' WHERE `Code` = 'NRU';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'NZL';
UPDATE `country` SET `HeadOfState` = 'Haitham bin Tariq' WHERE `Code` = 'OMN';
UPDATE `country` SET `HeadOfState` = 'Asif Ali Zardari' WHERE `Code` = 'PAK';
UPDATE `country` SET `HeadOfState` = 'Jose Raul Mulino' WHERE `Code` = 'PAN';
UPDATE `country` SET `HeadOfState` = 'Jose Enrique Jeri Ore' WHERE `Code` = 'PER';
UPDATE `country` SET `HeadOfState` = 'Bongbong Marcos' WHERE `Code` = 'PHL';
UPDATE `country` SET `HeadOfState` = 'Surangel Whipps Jr.' WHERE `Code` = 'PLW';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'PNG';
UPDATE `country` SET `HeadOfState` = 'Karol Nawrocki' WHERE `Code` = 'POL';
UPDATE `country` SET `HeadOfState` = 'Donald Trump' WHERE `Code` = 'PRI';
UPDATE `country` SET `HeadOfState` = 'Kim Jong-un' WHERE `Code` = 'PRK';
UPDATE `country` SET `HeadOfState` = 'Marcelo Rebelo de Sousa' WHERE `Code` = 'PRT';
UPDATE `country` SET `HeadOfState` = 'Santiago Pena' WHERE `Code` = 'PRY';
UPDATE `country` SET `HeadOfState` = 'Mahmoud Abbas' WHERE `Code` = 'PSE';
UPDATE `country` SET `HeadOfState` = 'Emmanuel Macron' WHERE `Code` = 'PYF';
UPDATE `country` SET `HeadOfState` = 'Tamim bin Hamad Al Thani' WHERE `Code` = 'QAT';
UPDATE `country` SET `HeadOfState` = 'Emmanuel Macron' WHERE `Code` = 'REU';
UPDATE `country` SET `HeadOfState` = 'Klaus Iohannis' WHERE `Code` = 'ROM';
UPDATE `country` SET `HeadOfState` = 'Vladimir Putin' WHERE `Code` = 'RUS';
UPDATE `country` SET `HeadOfState` = 'Paul Kagame' WHERE `Code` = 'RWA';
UPDATE `country` SET `HeadOfState` = 'Salman bin Abdulaziz' WHERE `Code` = 'SAU';
UPDATE `country` SET `HeadOfState` = 'Abdel Fattah al-Burhan' WHERE `Code` = 'SDN';
UPDATE `country` SET `HeadOfState` = 'Bassirou Diomaye Faye' WHERE `Code` = 'SEN';
UPDATE `country` SET `HeadOfState` = 'Tharman Shanmugaratnam' WHERE `Code` = 'SGP';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'SLB';
UPDATE `country` SET `HeadOfState` = 'Julius Maada Bio' WHERE `Code` = 'SLE';
UPDATE `country` SET `HeadOfState` = 'Nayib Bukele' WHERE `Code` = 'SLV';
UPDATE `country` SET `HeadOfState` = 'Hassan Sheikh Mohamud' WHERE `Code` = 'SOM';
UPDATE `country` SET `HeadOfState` = 'Carlos Vila Nova' WHERE `Code` = 'STP';
UPDATE `country` SET `HeadOfState` = 'Jennifer Geerlings-Simons' WHERE `Code` = 'SUR';
UPDATE `country` SET `HeadOfState` = 'Peter Pellegrini' WHERE `Code` = 'SVK';
UPDATE `country` SET `HeadOfState` = 'Natasa Pirc Musar' WHERE `Code` = 'SVN';
UPDATE `country` SET `HeadOfState` = 'Carl XVI Gustaf' WHERE `Code` = 'SWE';
UPDATE `country` SET `HeadOfState` = 'Mswati III' WHERE `Code` = 'SWZ';
UPDATE `country` SET `HeadOfState` = 'Wavel Ramkalawan' WHERE `Code` = 'SYC';
UPDATE `country` SET `HeadOfState` = 'Ahmad al-Sharaa' WHERE `Code` = 'SYR';
UPDATE `country` SET `HeadOfState` = 'Mahamat Idriss Deby' WHERE `Code` = 'TCD';
UPDATE `country` SET `HeadOfState` = 'Faure Gnassingbe' WHERE `Code` = 'TGO';
UPDATE `country` SET `HeadOfState` = 'Vajiralongkorn' WHERE `Code` = 'THA';
UPDATE `country` SET `HeadOfState` = 'Emomali Rahmon' WHERE `Code` = 'TJK';
UPDATE `country` SET `HeadOfState` = 'Serdar Berdimuhamedow' WHERE `Code` = 'TKM';
UPDATE `country` SET `HeadOfState` = 'Jose Ramos-Horta' WHERE `Code` = 'TLS';
UPDATE `country` SET `HeadOfState` = 'Tupou VI' WHERE `Code` = 'TON';
UPDATE `country` SET `HeadOfState` = 'Christine Kangaloo' WHERE `Code` = 'TTO';
UPDATE `country` SET `HeadOfState` = 'Kais Saied' WHERE `Code` = 'TUN';
UPDATE `country` SET `HeadOfState` = 'Recep Tayyip Erdogan' WHERE `Code` = 'TUR';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'TUV';
UPDATE `country` SET `HeadOfState` = 'Lai Ching-te' WHERE `Code` = 'TWN';
UPDATE `country` SET `HeadOfState` = 'Samia Suluhu Hassan' WHERE `Code` = 'TZA';
UPDATE `country` SET `HeadOfState` = 'Yoweri Museveni' WHERE `Code` = 'UGA';
UPDATE `country` SET `HeadOfState` = 'Volodymyr Zelenskyy' WHERE `Code` = 'UKR';
UPDATE `country` SET `HeadOfState` = 'Yamandu Orsi' WHERE `Code` = 'URY';
UPDATE `country` SET `HeadOfState` = 'Donald Trump' WHERE `Code` = 'USA';
UPDATE `country` SET `HeadOfState` = 'Shavkat Mirziyoyev' WHERE `Code` = 'UZB';
UPDATE `country` SET `HeadOfState` = 'Leo XIV' WHERE `Code` = 'VAT';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'VCT';
UPDATE `country` SET `HeadOfState` = 'Nicolas Maduro' WHERE `Code` = 'VEN';
UPDATE `country` SET `HeadOfState` = 'Charles III' WHERE `Code` = 'VGB';
UPDATE `country` SET `HeadOfState` = 'Donald Trump' WHERE `Code` = 'VIR';
UPDATE `country` SET `HeadOfState` = 'Luong Cuong' WHERE `Code` = 'VNM';
UPDATE `country` SET `HeadOfState` = 'Nikenike Vurobaravu' WHERE `Code` = 'VUT';
UPDATE `country` SET `HeadOfState` = 'Emmanuel Macron' WHERE `Code` = 'WLF';
UPDATE `country` SET `HeadOfState` = 'Tuimalealiifano Vaaletoa Sualauvi II' WHERE `Code` = 'WSM';
UPDATE `country` SET `HeadOfState` = 'Rashad al-Alimi' WHERE `Code` = 'YEM';
UPDATE `country` SET `HeadOfState` = 'Cyril Ramaphosa' WHERE `Code` = 'ZAF';
UPDATE `country` SET `HeadOfState` = 'Hakainde Hichilema' WHERE `Code` = 'ZMB';
UPDATE `country` SET `HeadOfState` = 'Emmerson Mnangagwa' WHERE `Code` = 'ZWE';

-- ============================================
-- MISES A JOUR DES POPULATIONS DES PAYS (2024-2025)
-- ============================================

UPDATE `country` SET `Population` = 43000000 WHERE `Code` = 'AFG';
UPDATE `country` SET `Population` = 37000000 WHERE `Code` = 'AGO';
UPDATE `country` SET `Population` = 2750000 WHERE `Code` = 'ALB';
UPDATE `country` SET `Population` = 10000000 WHERE `Code` = 'ARE';
UPDATE `country` SET `Population` = 46000000 WHERE `Code` = 'ARG';
UPDATE `country` SET `Population` = 26500000 WHERE `Code` = 'AUS';
UPDATE `country` SET `Population` = 9100000 WHERE `Code` = 'AUT';
UPDATE `country` SET `Population` = 10400000 WHERE `Code` = 'AZE';
UPDATE `country` SET `Population` = 11700000 WHERE `Code` = 'BEL';
UPDATE `country` SET `Population` = 175000000 WHERE `Code` = 'BGD';
UPDATE `country` SET `Population` = 6500000 WHERE `Code` = 'BGR';
UPDATE `country` SET `Population` = 216000000 WHERE `Code` = 'BRA';
UPDATE `country` SET `Population` = 41000000 WHERE `Code` = 'CAN';
UPDATE `country` SET `Population` = 8900000 WHERE `Code` = 'CHE';
UPDATE `country` SET `Population` = 19500000 WHERE `Code` = 'CHL';
UPDATE `country` SET `Population` = 1410000000 WHERE `Code` = 'CHN';
UPDATE `country` SET `Population` = 105000000 WHERE `Code` = 'COD';
UPDATE `country` SET `Population` = 52000000 WHERE `Code` = 'COL';
UPDATE `country` SET `Population` = 10900000 WHERE `Code` = 'CZE';
UPDATE `country` SET `Population` = 84000000 WHERE `Code` = 'DEU';
UPDATE `country` SET `Population` = 5950000 WHERE `Code` = 'DNK';
UPDATE `country` SET `Population` = 46000000 WHERE `Code` = 'DZA';
UPDATE `country` SET `Population` = 18200000 WHERE `Code` = 'ECU';
UPDATE `country` SET `Population` = 106000000 WHERE `Code` = 'EGY';
UPDATE `country` SET `Population` = 48500000 WHERE `Code` = 'ESP';
UPDATE `country` SET `Population` = 130000000 WHERE `Code` = 'ETH';
UPDATE `country` SET `Population` = 5550000 WHERE `Code` = 'FIN';
UPDATE `country` SET `Population` = 68500000 WHERE `Code` = 'FRA';
UPDATE `country` SET `Population` = 68000000 WHERE `Code` = 'GBR';
UPDATE `country` SET `Population` = 34500000 WHERE `Code` = 'GHA';
UPDATE `country` SET `Population` = 10400000 WHERE `Code` = 'GRC';
UPDATE `country` SET `Population` = 18000000 WHERE `Code` = 'GTM';
UPDATE `country` SET `Population` = 7500000 WHERE `Code` = 'HKG';
UPDATE `country` SET `Population` = 3850000 WHERE `Code` = 'HRV';
UPDATE `country` SET `Population` = 9600000 WHERE `Code` = 'HUN';
UPDATE `country` SET `Population` = 280000000 WHERE `Code` = 'IDN';
UPDATE `country` SET `Population` = 1440000000 WHERE `Code` = 'IND';
UPDATE `country` SET `Population` = 5200000 WHERE `Code` = 'IRL';
UPDATE `country` SET `Population` = 90000000 WHERE `Code` = 'IRN';
UPDATE `country` SET `Population` = 45000000 WHERE `Code` = 'IRQ';
UPDATE `country` SET `Population` = 9850000 WHERE `Code` = 'ISR';
UPDATE `country` SET `Population` = 58800000 WHERE `Code` = 'ITA';
UPDATE `country` SET `Population` = 123000000 WHERE `Code` = 'JPN';
UPDATE `country` SET `Population` = 20000000 WHERE `Code` = 'KAZ';
UPDATE `country` SET `Population` = 56000000 WHERE `Code` = 'KEN';
UPDATE `country` SET `Population` = 51500000 WHERE `Code` = 'KOR';
UPDATE `country` SET `Population` = 38000000 WHERE `Code` = 'MAR';
UPDATE `country` SET `Population` = 130000000 WHERE `Code` = 'MEX';
UPDATE `country` SET `Population` = 55000000 WHERE `Code` = 'MMR';
UPDATE `country` SET `Population` = 34500000 WHERE `Code` = 'MYS';
UPDATE `country` SET `Population` = 230000000 WHERE `Code` = 'NGA';
UPDATE `country` SET `Population` = 17900000 WHERE `Code` = 'NLD';
UPDATE `country` SET `Population` = 5550000 WHERE `Code` = 'NOR';
UPDATE `country` SET `Population` = 31000000 WHERE `Code` = 'NPL';
UPDATE `country` SET `Population` = 5300000 WHERE `Code` = 'NZL';
UPDATE `country` SET `Population` = 240000000 WHERE `Code` = 'PAK';
UPDATE `country` SET `Population` = 34000000 WHERE `Code` = 'PER';
UPDATE `country` SET `Population` = 117000000 WHERE `Code` = 'PHL';
UPDATE `country` SET `Population` = 37500000 WHERE `Code` = 'POL';
UPDATE `country` SET `Population` = 10400000 WHERE `Code` = 'PRT';
UPDATE `country` SET `Population` = 19000000 WHERE `Code` = 'ROM';
UPDATE `country` SET `Population` = 144000000 WHERE `Code` = 'RUS';
UPDATE `country` SET `Population` = 36000000 WHERE `Code` = 'SAU';
UPDATE `country` SET `Population` = 48000000 WHERE `Code` = 'SDN';
UPDATE `country` SET `Population` = 6000000 WHERE `Code` = 'SGP';
UPDATE `country` SET `Population` = 10600000 WHERE `Code` = 'SWE';
UPDATE `country` SET `Population` = 23000000 WHERE `Code` = 'SYR';
UPDATE `country` SET `Population` = 72000000 WHERE `Code` = 'THA';
UPDATE `country` SET `Population` = 86000000 WHERE `Code` = 'TUR';
UPDATE `country` SET `Population` = 23500000 WHERE `Code` = 'TWN';
UPDATE `country` SET `Population` = 67000000 WHERE `Code` = 'TZA';
UPDATE `country` SET `Population` = 48000000 WHERE `Code` = 'UGA';
UPDATE `country` SET `Population` = 37000000 WHERE `Code` = 'UKR';
UPDATE `country` SET `Population` = 340000000 WHERE `Code` = 'USA';
UPDATE `country` SET `Population` = 36000000 WHERE `Code` = 'UZB';
UPDATE `country` SET `Population` = 28500000 WHERE `Code` = 'VEN';
UPDATE `country` SET `Population` = 100000000 WHERE `Code` = 'VNM';
UPDATE `country` SET `Population` = 60000000 WHERE `Code` = 'ZAF';
UPDATE `country` SET `Population` = 16500000 WHERE `Code` = 'ZWE';

-- ============================================
-- NOUVEAUX PAYS (crees depuis 2000)
-- ============================================

-- Suppression de la Yougoslavie (remplacee par Serbie et Montenegro)
DELETE FROM `countrylanguage` WHERE `CountryCode` = 'YUG';
DELETE FROM `city` WHERE `CountryCode` = 'YUG';
DELETE FROM `country` WHERE `Code` = 'YUG';

-- Mise a jour East Timor (TMP -> TLS) avec nouvelles infos
UPDATE `country` SET `Code` = 'TLS', `Name` = 'Timor-Leste', `GovernmentForm` = 'Republic', `HeadOfState` = 'Jose Ramos-Horta', `Population` = 1340000, `IndepYear` = 2002 WHERE `Code` = 'TMP';
UPDATE `city` SET `CountryCode` = 'TLS' WHERE `CountryCode` = 'TMP';
UPDATE `countrylanguage` SET `CountryCode` = 'TLS' WHERE `CountryCode` = 'TMP';

INSERT INTO `country` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES ('SSD', 'South Sudan', 'Africa', 'Eastern Africa', 644329.0, 2011, 11400000, 58.6, 4100.0, NULL, 'South Sudan', 'Republic', 'Salva Kiir Mayardit', NULL, 'SS');
INSERT INTO `country` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES ('MNE', 'Montenegro', 'Europe', 'Southern Europe', 13812.0, 2006, 620000, 77.0, 6100.0, NULL, 'Crna Gora', 'Republic', 'Jakov Milatovic', NULL, 'ME');
INSERT INTO `country` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES ('SRB', 'Serbia', 'Europe', 'Southern Europe', 77474.0, 2006, 6650000, 76.0, 68000.0, NULL, 'Srbija', 'Republic', 'Aleksandar Vucic', NULL, 'RS');
INSERT INTO `country` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES ('XKX', 'Kosovo', 'Europe', 'Southern Europe', 10887.0, 2008, 1870000, 72.0, 9000.0, NULL, 'Kosova', 'Republic', 'Vjosa Osmani', NULL, 'XK');

-- ============================================
-- NOUVELLES VILLES (pour les nouveaux pays)
-- ============================================

INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES (4080, 'Juba', 'SSD', 'Central Equatoria', 450000);
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES (4081, 'Malakal', 'SSD', 'Upper Nile', 160000);
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES (4082, 'Wau', 'SSD', 'Western Bahr el Ghazal', 150000);
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES (4083, 'Podgorica', 'MNE', 'Podgorica', 190000);
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES (4084, 'Niksic', 'MNE', 'Niksic', 72000);
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES (4085, 'Belgrade', 'SRB', 'Belgrade', 1400000);
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES (4086, 'Novi Sad', 'SRB', 'Vojvodina', 380000);
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES (4087, 'Nis', 'SRB', 'Nis', 260000);
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES (4088, 'Pristina', 'XKX', 'Pristina', 210000);
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES (4089, 'Prizren', 'XKX', 'Prizren', 180000);

-- Mise a jour des capitales des nouveaux pays
UPDATE `country` SET `Capital` = 4080 WHERE `Code` = 'SSD';
UPDATE `country` SET `Capital` = 4083 WHERE `Code` = 'MNE';
UPDATE `country` SET `Capital` = 4085 WHERE `Code` = 'SRB';
UPDATE `country` SET `Capital` = 4088 WHERE `Code` = 'XKX';

-- ============================================
-- MISES A JOUR DES POPULATIONS DES VILLES (2024-2025)
-- ============================================

UPDATE `city` SET `Population` = 13960000 WHERE `Name` LIKE 'Tokyo%';
UPDATE `city` SET `Population` = 16800000 WHERE `Name` LIKE 'Delhi%';
UPDATE `city` SET `Population` = 24900000 WHERE `Name` LIKE 'Shanghai%';
UPDATE `city` SET `Population` = 21500000 WHERE `Name` LIKE 'Beijing%';
UPDATE `city` SET `Population` = 12700000 WHERE `Name` LIKE 'Mumbai%';
UPDATE `city` SET `Population` = 10300000 WHERE `Name` LIKE 'Dhaka%';
UPDATE `city` SET `Population` = 10000000 WHERE `Name` LIKE 'Cairo%';
UPDATE `city` SET `Population` = 9200000 WHERE `Name` LIKE 'Mexico City%';
UPDATE `city` SET `Population` = 12300000 WHERE `Name` LIKE 'Sao Paulo%';
UPDATE `city` SET `Population` = 15400000 WHERE `Name` LIKE 'Lagos%';
UPDATE `city` SET `Population` = 15500000 WHERE `Name` LIKE 'Istanbul%';
UPDATE `city` SET `Population` = 16500000 WHERE `Name` LIKE 'Karachi%';
UPDATE `city` SET `Population` = 17000000 WHERE `Name` LIKE 'Kinshasa%';
UPDATE `city` SET `Population` = 3100000 WHERE `Name` LIKE 'Buenos Aires%';
UPDATE `city` SET `Population` = 4600000 WHERE `Name` LIKE 'Kolkata%';
UPDATE `city` SET `Population` = 1850000 WHERE `Name` LIKE 'Manila%';
UPDATE `city` SET `Population` = 13800000 WHERE `Name` LIKE 'Tianjin%';
UPDATE `city` SET `Population` = 13500000 WHERE `Name` LIKE 'Guangzhou%';
UPDATE `city` SET `Population` = 12600000 WHERE `Name` LIKE 'Shenzhen%';
UPDATE `city` SET `Population` = 6750000 WHERE `Name` LIKE 'Rio de Janeiro%';
UPDATE `city` SET `Population` = 13000000 WHERE `Name` LIKE 'Lahore%';
UPDATE `city` SET `Population` = 12800000 WHERE `Name` LIKE 'Bangalore%';
UPDATE `city` SET `Population` = 13100000 WHERE `Name` LIKE 'Moscow%';
UPDATE `city` SET `Population` = 2160000 WHERE `Name` LIKE 'Paris%';
UPDATE `city` SET `Population` = 10900000 WHERE `Name` LIKE 'Lima%';
UPDATE `city` SET `Population` = 10700000 WHERE `Name` LIKE 'Bangkok%';
UPDATE `city` SET `Population` = 9000000 WHERE `Name` LIKE 'London%';
UPDATE `city` SET `Population` = 16300000 WHERE `Name` LIKE 'Chengdu%';
UPDATE `city` SET `Population` = 9430000 WHERE `Name` LIKE 'Nanjing%';
UPDATE `city` SET `Population` = 9500000 WHERE `Name` LIKE 'Tehran%';
UPDATE `city` SET `Population` = 9300000 WHERE `Name` LIKE 'Ho Chi Minh City%';
UPDATE `city` SET `Population` = 7500000 WHERE `Name` LIKE 'Hong Kong%';
UPDATE `city` SET `Population` = 8100000 WHERE `Name` LIKE 'Baghdad%';
UPDATE `city` SET `Population` = 12300000 WHERE `Name` LIKE 'Wuhan%';
UPDATE `city` SET `Population` = 10500000 WHERE `Name` LIKE 'Hyderabad%';
UPDATE `city` SET `Population` = 12200000 WHERE `Name` LIKE 'Hangzhou%';
UPDATE `city` SET `Population` = 7700000 WHERE `Name` LIKE 'Riyadh%';
UPDATE `city` SET `Population` = 5920000 WHERE `Name` LIKE 'Singapore%';
UPDATE `city` SET `Population` = 5600000 WHERE `Name` LIKE 'Santiago%';
UPDATE `city` SET `Population` = 3400000 WHERE `Name` LIKE 'Madrid%';
UPDATE `city` SET `Population` = 13000000 WHERE `Name` LIKE 'Xian%';
UPDATE `city` SET `Population` = 10800000 WHERE `Name` LIKE 'Suzhou%';
UPDATE `city` SET `Population` = 8400000 WHERE `Name` LIKE 'Ahmedabad%';
UPDATE `city` SET `Population` = 7400000 WHERE `Name` LIKE 'Dar es Salaam%';
UPDATE `city` SET `Population` = 6000000 WHERE `Name` LIKE 'Johannesburg%';
UPDATE `city` SET `Population` = 1650000 WHERE `Name` LIKE 'Barcelona%';
UPDATE `city` SET `Population` = 9900000 WHERE `Name` LIKE 'Haerbin%';
UPDATE `city` SET `Population` = 16800000 WHERE `Name` LIKE 'Chongqing%';
UPDATE `city` SET `Population` = 5700000 WHERE `Name` LIKE 'Ankara%';
UPDATE `city` SET `Population` = 8000000 WHERE `Name` LIKE 'Surat%';
UPDATE `city` SET `Population` = 5600000 WHERE `Name` LIKE 'Abidjan%';
UPDATE `city` SET `Population` = 5400000 WHERE `Name` LIKE 'Alexandria%';
UPDATE `city` SET `Population` = 5300000 WHERE `Name` LIKE 'Guadalajara%';
UPDATE `city` SET `Population` = 3750000 WHERE `Name` LIKE 'Casablanca%';
UPDATE `city` SET `Population` = 3750000 WHERE `Name` LIKE 'Berlin%';
UPDATE `city` SET `Population` = 4600000 WHERE `Name` LIKE 'Kabul%';
UPDATE `city` SET `Population` = 4700000 WHERE `Name` LIKE 'Jeddah%';
UPDATE `city` SET `Population` = 5400000 WHERE `Name` LIKE 'Sydney%';
UPDATE `city` SET `Population` = 5100000 WHERE `Name` LIKE 'Melbourne%';
UPDATE `city` SET `Population` = 5100000 WHERE `Name` LIKE 'Nairobi%';
UPDATE `city` SET `Population` = 4800000 WHERE `Name` LIKE 'Cape Town%';
UPDATE `city` SET `Population` = 3900000 WHERE `Name` LIKE 'Durban%';
UPDATE `city` SET `Population` = 5000000 WHERE `Name` LIKE 'Addis Ababa%';
UPDATE `city` SET `Population` = 6200000 WHERE `Name` LIKE 'Khartoum%';
UPDATE `city` SET `Population` = 8500000 WHERE `Name` LIKE 'Hanoi%';
UPDATE `city` SET `Population` = 5500000 WHERE `Name` LIKE 'Yangon%';
UPDATE `city` SET `Population` = 3900000 WHERE `Name` LIKE 'Algiers%';
UPDATE `city` SET `Population` = 3600000 WHERE `Name` LIKE 'Dubai%';
UPDATE `city` SET `Population` = 8300000 WHERE `Name` LIKE 'New York%';
UPDATE `city` SET `Population` = 3900000 WHERE `Name` LIKE 'Los Angeles%';
UPDATE `city` SET `Population` = 2700000 WHERE `Name` LIKE 'Chicago%';
UPDATE `city` SET `Population` = 2350000 WHERE `Name` LIKE 'Houston%';
UPDATE `city` SET `Population` = 1650000 WHERE `Name` LIKE 'Phoenix%';
UPDATE `city` SET `Population` = 1550000 WHERE `Name` LIKE 'Philadelphia%';
UPDATE `city` SET `Population` = 1500000 WHERE `Name` LIKE 'San Antonio%';
UPDATE `city` SET `Population` = 1400000 WHERE `Name` LIKE 'San Diego%';
UPDATE `city` SET `Population` = 1350000 WHERE `Name` LIKE 'Dallas%';
UPDATE `city` SET `Population` = 1000000 WHERE `Name` LIKE 'San Jose%';
UPDATE `city` SET `Population` = 690000 WHERE `Name` LIKE 'Washington%';
UPDATE `city` SET `Population` = 2930000 WHERE `Name` LIKE 'Toronto%';
UPDATE `city` SET `Population` = 9700000 WHERE `Name` LIKE 'Seoul%';
UPDATE `city` SET `Population` = 2750000 WHERE `Name` LIKE 'Osaka%';
UPDATE `city` SET `Population` = 2320000 WHERE `Name` LIKE 'Nagoya%';
UPDATE `city` SET `Population` = 1460000 WHERE `Name` LIKE 'Kyoto%';
UPDATE `city` SET `Population` = 1640000 WHERE `Name` LIKE 'Fukuoka%';
UPDATE `city` SET `Population` = 1520000 WHERE `Name` LIKE 'Kobe%';
UPDATE `city` SET `Population` = 3750000 WHERE `Name` LIKE 'Yokohama%';
UPDATE `city` SET `Population` = 920000 WHERE `Name` LIKE 'Amsterdam%';
UPDATE `city` SET `Population` = 660000 WHERE `Name` LIKE 'Rotterdam%';
UPDATE `city` SET `Population` = 550000 WHERE `Name` LIKE 'The Hague%';
UPDATE `city` SET `Population` = 520000 WHERE `Name` LIKE 'Lyon%';
UPDATE `city` SET `Population` = 870000 WHERE `Name` LIKE 'Marseille%';
UPDATE `city` SET `Population` = 2870000 WHERE `Name` LIKE 'Rome%';
UPDATE `city` SET `Population` = 1400000 WHERE `Name` LIKE 'Milan%';
UPDATE `city` SET `Population` = 920000 WHERE `Name` LIKE 'Naples%';
UPDATE `city` SET `Population` = 850000 WHERE `Name` LIKE 'Turin%';
UPDATE `city` SET `Population` = 2000000 WHERE `Name` LIKE 'Vienna%';
UPDATE `city` SET `Population` = 1860000 WHERE `Name` LIKE 'Warsaw%';
UPDATE `city` SET `Population` = 800000 WHERE `Name` LIKE 'Krakow%';
UPDATE `city` SET `Population` = 1750000 WHERE `Name` LIKE 'Budapest%';
UPDATE `city` SET `Population` = 1350000 WHERE `Name` LIKE 'Prague%';
UPDATE `city` SET `Population` = 1500000 WHERE `Name` LIKE 'Munich%';
UPDATE `city` SET `Population` = 1900000 WHERE `Name` LIKE 'Hamburg%';
UPDATE `city` SET `Population` = 1080000 WHERE `Name` LIKE 'Cologne%';
UPDATE `city` SET `Population` = 760000 WHERE `Name` LIKE 'Frankfurt%';
UPDATE `city` SET `Population` = 1220000 WHERE `Name` LIKE 'Brussels%';
UPDATE `city` SET `Population` = 980000 WHERE `Name` LIKE 'Stockholm%';
UPDATE `city` SET `Population` = 700000 WHERE `Name` LIKE 'Oslo%';
UPDATE `city` SET `Population` = 800000 WHERE `Name` LIKE 'Copenhagen%';
UPDATE `city` SET `Population` = 660000 WHERE `Name` LIKE 'Helsinki%';
UPDATE `city` SET `Population` = 640000 WHERE `Name` LIKE 'Athens%';
UPDATE `city` SET `Population` = 550000 WHERE `Name` LIKE 'Lisbon%';
UPDATE `city` SET `Population` = 240000 WHERE `Name` LIKE 'Porto%';
UPDATE `city` SET `Population` = 440000 WHERE `Name` LIKE 'Zurich%';
UPDATE `city` SET `Population` = 205000 WHERE `Name` LIKE 'Geneva%';
UPDATE `city` SET `Population` = 590000 WHERE `Name` LIKE 'Dublin%';
UPDATE `city` SET `Population` = 540000 WHERE `Name` LIKE 'Edinburgh%';
UPDATE `city` SET `Population` = 550000 WHERE `Name` LIKE 'Manchester%';
UPDATE `city` SET `Population` = 1150000 WHERE `Name` LIKE 'Birmingham%';
UPDATE `city` SET `Population` = 635000 WHERE `Name` LIKE 'Glasgow%';

-- ============================================
-- LANGUES DES NOUVEAUX PAYS
-- ============================================

INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('SSD', 'English', 'T', 0.0);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('SSD', 'Arabic', 'T', 0.0);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('SSD', 'Dinka', 'F', 35.0);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('SSD', 'Nuer', 'F', 15.0);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('MNE', 'Montenegrin', 'T', 37.0);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('MNE', 'Serbian', 'F', 42.0);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('MNE', 'Bosnian', 'F', 5.0);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('MNE', 'Albanian', 'F', 5.0);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('SRB', 'Serbian', 'T', 88.0);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('SRB', 'Hungarian', 'F', 3.5);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('SRB', 'Bosnian', 'F', 2.0);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('SRB', 'Romani', 'F', 1.5);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('XKX', 'Albanian', 'T', 92.0);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('XKX', 'Serbian', 'T', 5.0);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('XKX', 'Bosnian', 'F', 1.5);
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('XKX', 'Turkish', 'F', 1.0);
...
-- Renommages
UPDATE `country` SET `Name` = 'Czechia' WHERE `Code` = 'CZE';
UPDATE `country` SET `Name` = 'North Macedonia' WHERE `Code` = 'MKD';
UPDATE `country` SET `Name` = 'Eswatini' WHERE `Code` = 'SWZ';
UPDATE `country` SET `LocalName` = 'eSwatini' WHERE `Code` = 'SWZ';
UPDATE `country` SET `Name` = 'Turkiye' WHERE `Code` = 'TUR';

-- Barbade est devenue une republique en 2021
UPDATE `country` SET `GovernmentForm` = 'Republic' WHERE `Code` = 'BRB';
